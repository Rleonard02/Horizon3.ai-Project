...
def analyze_code(code_snippet):
    """
    Sends the code snippet to the Hugging Face Inference API for analysis.

    Args:
        code_snippet (str): The code snippet to analyze.

    Returns:
        str: The analysis output from the API, or None if an error occurred.
    """
    prompt = f"""
...
def main():
    ...
    if analysis_output:
        ...
        output_filename = f"{base_name}_qwen_25_72b.md"
